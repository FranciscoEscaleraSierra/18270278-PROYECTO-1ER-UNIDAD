...
if(isset($_POST['username']) && isset($_POST['password'])){
    if($_POST['username'] == 'administrador' && $_POST['password'] == 'nimda'){
        $_SESSION["user"] = 'admin';
        header('Location: http://localhost:8080/dashboard.php');
    }
    else if($_POST['username'] == 'cliente' && $_POST['password'] == 'etneilc'){
        $_SESSION["user"] = 'cliente';
        header('Location: http://localhost:8080/orders.php');
    }
